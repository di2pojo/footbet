...
exports.tournamentTemplate_get_all = (req, res, next) => {
...
exports.tournamentTemplate_create_tournamentTemplate = (req, res, next) => {
...
exports.tournamentTemplate_get_tournamentTemplate = (req, res, next) => {
...
exports.tournamentTemplate_delete_tournamentTemplate = (req, res, next) => {
  TournamentTemplate.findById(req.params.tournamentTemplateId)
    .select("matches name _id")
    .populate("matches", "matchNumber matchType homeTeam awayTeam")
    .exec()
